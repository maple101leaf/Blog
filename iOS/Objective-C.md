...
* [my-git](https://github.com/xirong/my-git) - git 的学习资料
* [gitignore](https://github.com/github/gitignore) 有用的.gitignore模板集合(忽略上传的文件集合)，包含了各种语言.

#### 完整App@
* [open-source-ios-apps](https://github.com/dkhamsing/open-source-ios-apps) - iOS开源App集合
* [NewsBlur](https://github.com/samuelclay/NewsBlur) - 作者Samuel Clay 写的一款名为 NewsBlur 的新闻阅读器, 很多人都称其为 Google Reader 的替代品。
* [HackerNews-React-Native](https://github.com/iSimar/HackerNews-React-Native) - 用 React Native 完成的 HackerNews 客户端 iOS Android都有。
* [WeChat](https://github.com/zhengwenming/WeChat) - 实现类似微信朋友圈或者QQ空间，评论回复，九宫格布局。处理键盘弹出后定位到当前点击的被评论人处。另：滑动时候FPS在57-60之间，纵享丝滑！
* [iOSAppTemplate](https://github.com/tbl00c/iOSAppTemplate) - 高仿微信UI，着重点在于设置界面的抽象和IM界面。
...
* [Monkey](https://github.com/coderyi/Monkey) - GitHub第三方iOS客户端 这次主要增加了登录GitHub的功能，随手follow和star，并且增加发现模块，包括GitHub的trending，动态，showcases等。
* [firefox-ios](https://github.com/mozilla/firefox-ios) Firefox for iOS
* [RSSRead](https://github.com/ming1016/RSSRead) “已阅”是一个iOS设备上的RSS/Atom阅读器。
* [zulip-ios](https://github.com/zulip/zulip-ios) Dropbox收购公司内部社交服务商Zulip,然后全部开源.
* [ChatSecure-iOS](https://github.com/ChatSecure/ChatSecure-iOS) - Objective-C写的XMPP消息客户端iOS集成工程和omemo加密消息的支持，并通过Tor网络连接可选的集成支持。

* [FirebaseChat](https://github.com/relatedcode/FirebaseChat) - Objective-C原生的iOS Messenger应用程序，音频/视频通话和实时聊天对话（全脱机支持）。
...
* [Sol](https://github.com/comyarzaheri/Sol) - Sol°美丽显示天气信息，所以你可以计划你的一天。检查天气在您当前的位置或任何城市在世界各地。
...
* [WNXHuntForCity](https://github.com/ZhongTaoTian/WNXHuntForCity) - iOS高仿城觅项目 Objective-C版本
* [breadwallet](https://github.com/voisine/breadwallet) - breadwallet - bitcoin wallet最简单和最安全的比特币钱包在任何平台上
...
* [TeamTalk](https://github.com/mogujie/TeamTalk) - 蘑菇街TeamTalk. 开源企业级IM
* [MessageDisplayKit](https://github.com/xhzengAIB/MessageDisplayKit) - IM应用程序像WeChat App发送文字、图片、音频、视频、位置信息、地址簿管理、分享朋友圈，漂流的朋友们，摇一个有趣和更有趣的功能。
...
* [GSD_WeiXin](https://github.com/gsdios/GSD_WeiXin) - 高仿微信 不断更新
...
* [MVVMReactiveCocoa](https://github.com/leichunfeng/MVVMReactiveCocoa) - GitBucket 2.0 对 MVVM 和 RAC 的 iOS 开发者有所帮助。[AppStore地址](https://itunes.apple.com/cn/app/id961330940?mt=8)
* [WNXHuntForCity](https://github.com/ZhongTaoTian/WNXHuntForCity) - iOS高仿城觅项目（开发思路和代码）。
* [ZYChat](https://github.com/zyprosoft/ZYChat) - 聊天UI框架，针对高速高频刷新最近会话和对话页面做了优化处理,支持单聊，群聊,优化支持更多消息类型:文本表情混排,多图发送，Gif动画，短视频，语音，音乐分享，网页分享，鲜花特效。UI框架参考MVVM思想设计.
* [meituan](https://github.com/lookingstars/meituan) - 美团5.7iOS版（高仿），功能包括，团购首页，高德地图搜索附近美食并显示在地图上，上门服务，商家，友盟分享。
* [JFMeiTuan](https://github.com/tubie/JFMeiTuan) - 高仿美团应用界面构建的 iOS 应用。
* [SXNews](https://github.com/dsxNiubility/SXNews) - 模仿网易新闻做的新闻软件，完成了主导航页，新闻详情页，图片浏览页，评论页。效果不错，比网上流传的各种和网易新闻UI架构有关的代码都要完整，都要好。
* [Uther](https://github.com/callmewhy/Uther) -  与可爱的外星人聊天，帮你做备忘录！。[itunes下载](https://itunes.apple.com/cn/app/uther/id1024104920) 。
* [高仿斗鱼TV](http://code.cocoachina.com/view/128246) - 高仿斗鱼TV，点击头部滚动视图可以播放视频。
* [react-native-gitfeed](https://github.com/xiekw2010/react-native-gitfeed) - React native 写的github客户端了。
* [phphub-ios](https://github.com/Aufree/phphub-ios) - PHPHub的iOS客户端，同时兼容iPhone和iPad。
* [LeagueofLegends](https://git.oschina.net/smithy/GameProject.git) - 一个关于英雄联盟的完整iOS开源项目，接口均来自多玩，腾讯各大游戏平台。
...
* [YoCelsius](https://github.com/YouXianMing/YoCelsius) - 一款天气预报的应用,点击查看 最美应用 介绍。视频 优酷 或者 YouTube
...
* [ECMobile_iOS](https://github.com/GeekZooStudio/ECMobile_iOS) - ECMobile 是基于 ECShop 的手机商城客户端，包括iOS、Android、PHP三个平台源代码及框架已开放下载！
* [BDJProjectExample](https://github.com/yizzuide/BDJProjectExample) - 一个基于XFLegoVIPER框架编写的完整项目

#### Xcode8插件@

* [FLEX](https://github.com/Flipboard/FLEX) - FLEX是一个需要注入式的一种框架，从描述来看，功能非常多。主要来讲的话能够对正在运行的应用进行样式的修改和控件的读取。
  1. 可以查看控件的坐标和属性
  2. 看任何一个对象的属性和成员变量
  3. 动态修改属性和成员变量
  4. 动态的调用实例和类方法
- [Import](https://github.com/markohlebar/Import) - 快捷导入头文件-Xcode extension for adding imports from anywhere in the code.
- [XcodeSourceEditorExtension-Alignment](https://github.com/tid-kijyun/XcodeSourceEditorExtension-Alignment) - 对齐属性声明。
- [Dash-iOS](https://github.com/Kapeli/Dash-iOS) - Dash Xcode插件https://kapeli.com/dash_ios
...
* [ReactiveCocoa例子](http://iiiyu.com/2014/12/26/learning-ios-notes-thirty-six/)
...
* [小码哥：快速让你上手ReactiveCocoa之基础篇](http://www.jianshu.com/p/87ef6720a096)
* [samurai-native](https://github.com/hackers-painters/samurai-native) - 是一个基于浏览器内核通过HTML+CSS 开发原生移动应用的iOS框架。
* [HHRouter](https://github.com/Huohua/HHRouter) - URL Router 即将 UIViewController 映射成 URL，从而支持通过 URL 进行界面跳转。URL Router 有着许多切实的好处。
...
* [Material-Controls-For-iOS](https://github.com/fpt-software/Material-Controls-For-iOS) 许多Google Material Design Controls for iOS原生应用程序
...
* [DBDynamicTree](https://github.com/reference/BDDynamicTree.git) - 动态树形结构菜单 实现任意多层的树形菜单结构，简单方便，配置轻松。
...
* [PBJVision](视频@) iOS媒体捕获，点击录制视频，显示运动和照片. 📸 iOS Media Capture – features touch-to-record video, slow motion, and photography
