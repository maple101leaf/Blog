...
- [UI@](#UI)
  ...
  - [颜色@](#颜色)
  - [图表@](#图表)
  - [表相关(TabbleView、即时聊天界面)@](#表相关tabbleview即时聊天界面)
  - [隐藏与显示@](#隐藏与显示)
  - [HUD与Toast@](#hud与toast)
  - [对话框@](#对话框)
  - [popover@](#popover)
...
* [SwiftGuide](https://github.com/ipader/SwiftGuide) Swift学习资料
...
* [30DaysofSwift](https://github.com/allenwong/30DaysofSwift) - 30DaysofSwift 自学 iOS。
...
* [iOS8-day-by-day](https://github.com/shinobicontrols/iOS8-day-by-day) - swift。iOS8的新特征
* [iOS9-day-by-day](https://github.com/shinobicontrols/iOS9-day-by-day) - swfit。iOS9的新特征 [iOS9 Day-by-Day :: Day 2 :: UI Testing](http://www.jianshu.com/p/039f8de6ee4d)。
* [iOS10-day-by-day](https://github.com/shinobicontrols/iOS10-day-by-day) - swift。iOS10的新特征。
...
* [Eidolon](https://github.com/artsy/eidolon) - 艺术品拍卖的投标亭平台，用swift与响应式编程框架（ReactiveCocoa）。
* [BaiduFM-Swift](https://github.com/belm/BaiduFM-Swift) - 百度FM, swift语言实现，基于xcode6.3+swift1.2，支持Apple Watch。
...
* [SimpleMemo](https://github.com/likumb/SimpleMemo) - 易便签, 适配Swift 3.0 加强 3D Touch 功能 移除 ShareExtension、WatchExten 使用SwiftLint检查代码风格。
* [furni-ios.swift](https://github.com/twitterdev/furni-ios) - furni是一款用 Swift 写的 iOS 家居商城应用, 其主要目的在于让开发者从这款 Demo 应用中看出 Fabric平台的强大。
* [SelectionOfZhihu.swift](https://github.com/sheepy1/SelectionOfZhihu) - 『看知乎』iOS 客户端, [项目说明](http://www.jianshu.com/p/2c3a0f109788)。
* [Yep.swift](https://github.com/CatchChat/Yep) - Yep 一个天才使用的社交软件。
* [LoveFreshBeen.swift](https://github.com/ZhongTaoTian/LoveFreshBeen) - 高仿爱鲜蜂 - Swift2.0
* [trySwiftApp.swift](https://github.com/tryswift/trySwiftApp) - trySwiftApp一款较为完整的会议原型应用。
* [PinGo.swift](https://github.com/gaowanli/PinGo) - PinGo.纯Swift编写的仿“随遇”App。
...
* [katana-swift](https://github.com/BendingSpoons/katana-swift) - 一个用于编写iOS应用程序的现代Swift框架，灵感来自React和Redux。Swift Apps in a Swoosh! A modern framework for creating iOS apps, inspired by React and Redux. http://katana.bendingspoons.com
...
* [Tomate](https://github.com/dasdom/Tomate) - 圆盘式计时器让你更专注于工作或学习。
...
* [XLPagerTabStrip](https://github.com/xmartlabs/XLPagerTabStrip) - iOS下的PagerTabStrip。
...
* [IGColorPicker](https://github.com/iGenius-Srl/IGColorPicker) - 一个自定义颜色选择器

#### 其他UI@
* [KDCircularProgress](https://github.com/kaandedeoglu/KDCircularProgress) -  KDCircularProgress是使用swift制作的色彩炫丽的环形进度条，可以加入多种颜色来控制进度条的渐变效果。
...
* [InkKit.swift](https://github.com/shaps80/InkKit) - 帮助开发者绘制简单图形更容易。
* [SwiftSVG](https://github.com/mchoe/SwiftSVG) - 支持多种接口（String, NS/UIBezierPath, CAShapeLayer, and NS/UIView）绘制 SVG 类库。
* [LeeGo.swift](https://github.com/wangshengjia/LeeGo) - leego是一个轻量级的框架，可以帮助你迅速将你的UI组件和模块化为小块的乐高风格的砖，使UI开发的陈述，可配置性和高度可重用。[用 struct 和 enum 来构建你的整套 UI](http://allblue.me/swift/2016/05/26/LeeGo-chinese-version/)
...
* [NumberMorphView.swift](https://github.com/me-abhinav/NumberMorphView) - 数字变身动画类库。
...
* [15DaysofAnimationsinSwift](https://github.com/larrynatalicio/15DaysofAnimationsinSwift) - 15天动画汇集Swift。
* [Interpolate.swift](https://github.com/marmelroy/Interpolate) - 手势驱动交互式转场动画框架库。
...
* [Swimat](https://github.com/Jintin/Swimat) - Swimat，是一款Xcode 插件，一键格式化 swift 代码。
...
## 测试及调试@
* [depcheck](https://github.com/wojteklu/depcheck) Swift 工程依赖分析工具可产生依赖图
* [CleanroomLogger](https://github.com/emaloney/CleanroomLogger) - Log工具类似 CocoaLumberjack 或 Log4j 的 Swift 版本，源代码中已经内含了完整的 API 文档，使用非常方便。
* [Quick](https://github.com/Quick/Quick) - 用于Swift中的单元测试（也可用于Objective-C），与Xcode整合在一起。Objective-C建议用Specta。
